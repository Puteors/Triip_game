class Scene2 extends Phaser.Scene {
    ...
    create () {
        ...
        this.background = this.add.tileSprite(0, 0, 7680, 1080, 'layout1').setOrigin(0, 0).setScrollFactor(0);
        ...
        this.background2 = this.add.tileSprite(0, 0, 7680, 1080, 'layout3').setOrigin(0).setScrollFactor(0);
        this.cameras.main.setBounds(0, 0, 4320, 1080)
        this.myCam = this.cameras.main.startFollow(this.player);
        this.statusHpBar = this.add.image(100,config.height/4, 'name').setOrigin(0);
    ...
    update () {
        if(this.isRunning){
            ...
            this.background2.tilePositionX = this.myCam.scrollX * 1.5;
